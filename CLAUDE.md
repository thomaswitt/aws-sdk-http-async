...
- `async_http_max_buffer_bytes` default 5MB and enforced everywhere (Strings,
...
- `async_http_idle_timeout` is used as the endpoint timeout when
  `http_open_timeout` is unset.
